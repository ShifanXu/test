...
%-------------------------------------------------------------------------------
\name{Shifan Xu}{}
\position{Ph.D. Candidate in Applied Physics}
\address{Yale University, CT, USA, 06511}

\mobile{+1 475-280-8083}
\email{shifan.xu@yale.edu}
\homepage{www.shifanxu.com}
%\github{mygithub}
\linkedin{www.linkedin.com/in/shifan-xu-92817721b/}
% \gitlab{my-gitlab-id}
